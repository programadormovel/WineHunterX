...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "WineHunterX.Android.dll" comes first in this list. */
		"WineHunterX.Android.dll",
		"AngleSharp.dll",
		"Autofac.dll",
		...
		"Tesseract.Droid.dll",
		"WineHunterX.dll",
		"Xamarians.CropImage.dll",
		"Xamarians.CropImage.Droid.dll",
